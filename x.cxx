...
// Date:               14/11/2021 21.4 (DD/MM/YYYY) (HH.MM)
...
void _main(){
  array<array<array<str>>> _my_array = array<array<array<str>>>({array<array<str>>({array<str>({L"Apple"}), array<str>({L"Banana"})}), array<array<str>>({array<str>({L"Bred"}), array<str>({L"Cheese"})})});
  _outln(_my_array);
}
