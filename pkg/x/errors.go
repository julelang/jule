...
var Errors = map[string]string{
	...
	`invalid_type_for_default_arg`:             `%s is invalid data type source for default argument with default expression`,
	...
	`default_for_autotype`:                     `default is cannot use with auto-type definitions`,
