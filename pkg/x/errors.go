...
var Errors = map[string]string{
	...
	`initpoint_have_return`:         `init point is cannot have return type`,
	`initpoint_have_parameters`:     `init point is cannot have parameter(s)`,
	`initpoint_have_attributes`:     `init point is cannot have attribute(s)`,
