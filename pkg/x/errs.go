...
var Errs = map[string]string{
	...
	"invalid_type_unary_minus":         "invalid data-type for unary - operator",
	"invalid_type_unary_plus":          "invalid data-type for unary + operator",
	"invalid_type_unary_tilde":         "invalid data-type for unary ~ operator",
	"invalid_type_unary_logical_not":   "invalid data-type for unary ! operator",
	"invalid_type_unary_star":          "invalid data-type for unary * operator",
