...
public:
    ...
    static __jule_U8 *alloc(const __jule_Int len) noexcept {
        __jule_U8 *buf = static_cast<__jule_U8 *>(
            __jule_malloc(len * sizeof(__jule_U8), false));
        if (!buf) [[unlikely]] {
    ...
    static __jule_U8 at(const char *file, const __jule_U8 *s,
    ...
    void mut_slice(const __jule_Int &start, const __jule_Int &end) noexcept {
        this->_slice += start;
        this->_len = end - start;
    }
    ...
    inline void mut_slice(void) noexcept { this->mut_slice(0, this->_len); }
    ...
    inline __jule_U8 &safe_at(const char *file,
    ...
    inline __jule_Bool equal(const char *s, const __jule_Int n) const noexcept {
        ...
        return std::strncmp(reinterpret_cast<const char *>(this->begin()), s,
                            this->_len) == 0;
    }
