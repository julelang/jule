...
namespace jule {
    ...
    public:
        ...
        { return reinterpret_cast<Iterator>(this->buffer.data()); }

        inline ConstIterator begin(void) const noexcept
        { return reinterpret_cast<ConstIterator>(this->buffer.data()); }

        inline Iterator end(void) noexcept
        { return reinterpret_cast<Iterator>(this->buffer.data()+this->_len); }

        inline ConstIterator end(void) const noexcept
        { return reinterpret_cast<ConstIterator>(this->buffer.data()+this->_len); }
        ...
        operator jule::Slice<jule::U8>(void) const noexcept {
            ...
            std::copy(this->begin(), this->begin()+this->_len, slice._slice);
            return slice;
        }
